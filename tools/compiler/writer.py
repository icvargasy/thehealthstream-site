...
def render_interactive_sample_card() -> str:
    """Renders an ultra-low vertical height visitor guide legend at the top of index.html."""
    git_branch_svg = (
        '<svg class="pipeline-icon-svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">'
        '  <line x1="6" y1="3" x2="6" y2="15"></line>'
        '  <circle cx="18" cy="6" r="3"></circle>'
    ...
    return (
        ...
        '  </div>'
        '  <div class="guide-micro-legend-row">'
        '    <!-- Micro-Bar 1: Summaries -->'
        '    <div class="micro-legend-bar bar-summaries">'
        '      <span class="category-tag tag-micro">BIOLOGY</span>'
        '      <span class="evidence-badge tier-consensus badge-micro">✓✓ Consensus Core</span>'
        '      <span class="micro-label"><strong>Summaries:</strong> Published decodings with 1-min takeaways &amp; mechanism deep dives</span>'
        '    </div>'
        '    <!-- Micro-Bar 2: In the Pipeline -->'
        '    <div class="micro-legend-bar bar-pipeline">'
        '      <span class="category-tag tag-micro">LIFESTYLE</span>'
        '      <span class="pipeline-badge badge-micro">' + git_branch_svg + 'In the Pipeline</span>'
        '      <span class="micro-label"><strong>In the Pipeline:</strong> Reader-proposed topics — click <span class="upvote-pill-preview">▲ Upvote</span> to prioritize</span>'
        '    </div>'
        '  </div>'
        '</div>'
    )
