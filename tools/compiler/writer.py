...
def render_interactive_sample_card() -> str:
    """Renders a neutral-themed visitor guide legend with 1:1 miniature card replicas matching Screenshot 2 geometry."""
    git_branch_svg = (
        '<svg class="pipeline-icon-svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">'
        '  <line x1="6" y1="3" x2="6" y2="15"></line>'
        '  <circle cx="18" cy="6" r="3"></circle>'
    ...
    return (
        '<div class="visitor-guide-neutral-card" id="sample-decoding-card-0" data-created="9999-99-99" data-title="How to Navigate The Healthstream Registry" data-category="biology" data-grade="high" data-tier="consensus-core" style="display: none;">'
        '  <div class="guide-card-header">'
        '    <div class="guide-title-group">'
        '      <span class="guide-welcome-badge">Welcome &amp; How It Works</span>'
        '      <h2 class="guide-heading">Navigating The Healthstream Feed</h2>'
        '    </div>'
        '    <button class="dismiss-guide-btn" id="dismiss-sample-card" aria-label="Dismiss welcome guide">Dismiss Guide &times;</button>'
        '  </div>'
        '  <div class="guide-faithful-grid">'
        '    <!-- Faithful Mini-Card 1: Pipeline Proposal Card -->'
        '    <div class="guide-card-wrapper">'
        '      <div class="feed-card pipeline-card-merged cat-biology guide-mini-card">'
        '        <div class="feed-card-header">'
        '          <div class="feed-card-title-group">'
        '            <h3 class="card-title mini-title">'
        '              <span class="card-title-link">Vitamin-Microbiome Bidirectional Loop</span>'
        '            </h3>'
        '            <div class="mini-tag-row">'
        '              <span class="category-tag">BIOLOGICAL CIRCUITS</span>'
        '              <span class="pipeline-badge">' + git_branch_svg + 'IN THE PIPELINE</span>'
        '              <span class="evidence-badge tier-emerging">&plus; EMERGING FRONTIER</span>'
        '            </div>'
        '          </div>'
        '          <button class="backlog-votes vote-cta-btn mini-btn-top" style="pointer-events: none;" aria-label="Upvote topic proposal">'
        '            <span class="upvote-icon">▲</span>'
        '            <span class="vote-label">UPVOTE</span>'
        '            <span class="vote-count">(0)</span>'
        '          </button>'
        '        </div>'
        '        <blockquote class="card-teaser-text card-analogy-block mini-analogy-block">'
        '          <div class="card-analogy-hook">'
        '            <span class="analogy-badge-label">' + SYNAPSE_LOGO_SVG + ' <strong>SYSTEMS ANALOGY:</strong></span> '
        '            <span class="analogy-text">A local farming cooperative exchanging raw harvests for specialized municipal energy supplies.</span>'
        '          </div>'
        '        </blockquote>'
        '        <div class="card-footer-row mini-footer">'
        '          <div class="card-tags">'
        '            <span class="tag-pill">#biology</span>'
        '            <span class="tag-pill">#metabolism</span>'
        '          </div>'
        '          <div class="card-meta-dates">Proposed: 2026-06-15</div>'
        '        </div>'
        '      </div>'
        '      <div class="guide-card-caption">🌿 <strong>In the Pipeline:</strong> Reader-submitted topics. Click <strong>▲ Upvote</strong> to prioritize research!</div>'
        '    </div>'
        '    <!-- Faithful Mini-Card 2: Published Summary Card -->'
        '    <div class="guide-card-wrapper">'
        '      <div class="feed-card cat-biology guide-mini-card">'
        '        <div class="feed-card-header">'
        '          <div class="feed-card-title-group">'
        '            <h3 class="card-title mini-title">'
        '              <span class="card-title-link">DHA Target Engagement &amp; Cognition in Dementia Risk</span>'
        '            </h3>'
        '            <div class="mini-tag-row">'
        '              <span class="category-tag">BIOLOGICAL CIRCUITS</span>'
        '              <span class="evidence-badge tier-consensus">✓ CONSENSUS CORE</span>'
        '            </div>'
        '          </div>'
        '          <span class="read-article-btn mini-btn-top" style="pointer-events: none;">'
        ...
        '          <div class="card-analogy-hook">'
        '            <span class="analogy-badge-label">' + SYNAPSE_LOGO_SVG + ' <strong>SYSTEMS ANALOGY:</strong></span> '
        '            <span class="analogy-text">Supplying high-octane fuel to an engine with clogged fuel injectors fails to restore peak horsepower.</span>'
        '          </div>'
        '        </blockquote>'
        '        <div class="card-footer-row mini-footer">'
        '          <div class="card-tags">'
        '            <span class="tag-pill">#biology</span>'
        '            <span class="tag-pill">#longevity</span>'
        '          </div>'
        '          <div class="card-meta-dates">Created: 2026-06-01</div>'
        '        </div>'
        '      </div>'
        '      <div class="guide-card-caption">📖 <strong>Summaries:</strong> Completed decodings with 1-min takeaways &amp; mechanism deep dives.</div>'
        '    </div>'
        '  </div>'
        '</div>'
    )
