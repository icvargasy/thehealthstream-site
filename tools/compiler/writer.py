...
def render_interactive_sample_card() -> str:
    """Renders a neutral-themed visitor guide legend with plain wireframe mocks at the top of index.html."""
    return (
        ...
        '      <h2 class="guide-heading">Navigating The Healthstream Registry</h2>'
        '    </div>'
        '    <button class="dismiss-guide-btn" id="dismiss-sample-card" aria-label="Dismiss welcome guide">Dismiss Guide &times;</button>'
        '  </div>'
        '  <p class="guide-intro-text">Our feed presents two distinct entry formats: <strong>Published Decodings</strong> (with full summaries) and <strong>Pipeline Proposals</strong> (community topics under scientific review).</p>'
        '  <div class="guide-wireframe-grid">'
        '    <!-- Mock 1: Published Summary Card -->'
        '    <div class="wireframe-mock-card mock-published">'
        '      <div class="mock-card-header">'
        '        <span class="mock-badge mock-tier-consensus">✓✓ Consensus Core (Tier 1)</span>'
        '        <span class="mock-category-tag">BIOLOGY</span>'
        '      </div>'
        '      <h4 class="mock-card-title">1. Published Article Decodings</h4>'
        '      <p class="mock-analogy-text">💡 <strong>Systems Analogy:</strong> A municipal rationing protocol resetting peripheral supply routes to quiet central security patrols.</p>'
        '      <div class="mock-card-footer">'
        '        <span class="mock-read-btn">Read Summary &rarr;</span>'
        '      </div>'
        '    </div>'
        '    <!-- Mock 2: Pipeline Proposal Card -->'
        '    <div class="wireframe-mock-card mock-pipeline">'
        '      <div class="mock-card-header">'
        '        <span class="mock-badge mock-pipeline-tag">🌿 In the Pipeline</span>'
        '        <span class="mock-category-tag">LIFESTYLE</span>'
        '      </div>'
        '      <h4 class="mock-card-title">2. Reader Topic Proposals</h4>'
        '      <p class="mock-description-text">Proposed questions undergoing citation auditing. Upvote topics to prioritize their static compilation!</p>'
        '      <div class="mock-card-footer">'
        '        <span class="mock-upvote-btn">▲ Upvote (14)</span>'
        '      </div>'
        '    </div>'
        '  </div>'
        '</div>'
