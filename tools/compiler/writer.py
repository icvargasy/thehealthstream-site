...
def render_interactive_sample_card() -> str:
    """Renders a neutral-themed visitor guide legend with authentic micro-scaled card components at the top of index.html."""
    git_branch_svg = (
        '<svg class="pipeline-icon-svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">'
        '  <line x1="6" y1="3" x2="6" y2="15"></line>'
        '  <circle cx="18" cy="6" r="3"></circle>'
    ...
    return (
        ...
        '  </div>'
        '  <p class="guide-intro-text">The feed contains two entry formats: <strong>Published Decodings</strong> (with full summaries) and <strong>Pipeline Proposals</strong> (community topics you can upvote).</p>'
        '  <div class="guide-wireframe-grid">'
        '    <!-- Mini Card 1: Published Article Decoding -->'
        '    <div class="feed-card cat-biology guide-mini-card">'
        '      <div class="feed-card-header">'
        '        <div class="feed-card-title-group">'
        '          <h3 class="card-title" style="font-size: 0.95rem; margin: 0 0 4px 0;">'
        '            <span class="card-title-link">1. Published Article Decodings</span>'
        '          </h3>'
        ...
        '          </div>'
        '        </div>'
        '        <span class="read-article-btn guide-mock-btn" style="pointer-events: none;">'
        '          <span>Read Summary</span>'
        '          <span>&rarr;</span>'
        '        </span>'
        '      </div>'
        '      <blockquote class="card-teaser-text card-analogy-block" style="margin: var(--space-2) 0 0 0; padding: var(--space-2); font-size: 0.82rem;">'
        '        <div class="card-analogy-hook">'
        '          <span class="analogy-badge-label">' + SYNAPSE_LOGO_SVG + ' <strong>Systems Analogy:</strong></span> '
        '          <span class="analogy-text">A municipal rationing protocol resetting peripheral supply routes to quiet central security patrols.</span>'
        '        </div>'
        '      </blockquote>'
        '    </div>'
        '    <!-- Mini Card 2: Pipeline Proposal Topic -->'
        '    <div class="feed-card pipeline-card-merged cat-lifestyle guide-mini-card">'
        '      <div class="feed-card-header">'
        '        <div class="feed-card-title-group">'
        '          <h3 class="card-title" style="font-size: 0.95rem; margin: 0 0 4px 0;">'
        '            <span class="card-title-link">2. Reader Topic Proposals</span>'
        '          </h3>'
        '          <div style="display: flex; gap: var(--space-1); align-items: center; flex-wrap: wrap;">'
        '            <span class="category-tag">LIFESTYLE</span>'
        '            <span class="pipeline-badge">' + git_branch_svg + 'In the Pipeline</span>'
        '            <span class="evidence-badge tier-emerging">🔬 Emerging Frontier (Tier 2)</span>'
        '          </div>'
        '        </div>'
        '        <button class="backlog-votes vote-cta-btn guide-mock-upvote" style="pointer-events: none;" aria-label="Upvote topic proposal">'
        '          <span class="upvote-icon">▲</span>'
        '          <span class="vote-label">Upvote</span>'
        '          <span class="vote-count">(14)</span>'
        '        </button>'
        '      </div>'
        '      <p class="guide-mini-desc" style="font-size: 0.82rem; color: var(--text-ink-muted); margin: var(--space-2) 0 0 0; line-height: 1.4;">'
        '        Reader-submitted topics under citation auditing. Click Upvote to prioritize research and full decoding.'
        '      </p>'
        '    </div>'
        '  </div>'
        '</div>'
