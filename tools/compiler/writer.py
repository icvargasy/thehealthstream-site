...
def render_interactive_sample_card() -> str:
    ...
    return (
        ...
        '    The Healthstream decodes the full evidence spectrum — from consensus science to early frontier research, always free. <a href="about.html" class="guide-mission-link">Our mission →</a>'
        '  </p>'
        ...
        '          <div class="guide-mock-footer-left">'
        '            <div class="guide-mock-tags">'
        '              <span class="guide-mock-pill">#domaintag1</span>'
        '              <span class="guide-mock-pill">#domaintag2</span>'
        '            </div>'
        '            <span class="guide-mock-date">Proposed: YYYY-MM-DD</span>'
        '          </div>'
        '          <div class="guide-mock-footer-right">'
        ...
        '    <div class="guide-mock-wrapper">'
        '      <div class="guide-mock-intro">'
        '        <span class="intro-title-badge">' + summary_step_icon + ' <strong>Summaries:</strong></span> Completed decodings with key takeaways across consensus, emerging, and exploratory tiers.'
        '      </div>'
        '      <div class="guide-mock-card mock-summary">'
        '        <h3 class="guide-mock-title">Sample Summary Article Title</h3>'
        '        <div class="guide-mock-tag-row">'
        '          <span class="guide-mock-tag">TOPIC CATEGORY</span>'
        '          <span class="guide-mock-badge">✓ EVIDENCE TIER</span>'
        '        </div>'
        ...
        '              <span class="guide-mock-pill">#domaintag2</span>'
        '            </div>'
        '            <span class="guide-mock-date">Created: YYYY-MM-DD</span>'
        '          </div>'
        '          <div class="guide-mock-footer-right">'
        '            <span class="guide-mock-btn mock-btn-read" style="pointer-events: none;">'
        '              Read Summary &rarr;'
        '            </span>'
        '          </div>'
        '        </div>'
