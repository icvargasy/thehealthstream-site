...
def render_interactive_sample_card() -> str:
    """Renders a visitor guide banner embedding complete 4-layer card visual tokens at the top of index.html."""
    git_branch_svg = (
        '<svg class="pipeline-icon-svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">'
        '  <line x1="6" y1="3" x2="6" y2="15"></line>'
        '  <circle cx="18" cy="6" r="3"></circle>'
    ...
    return (
        '<div class="visitor-guide-banner" id="sample-decoding-card-0" style="display: none;">'
        ...
        '  </div>'
        '  <div class="guide-token-grid">'
        '    <!-- Panel 1: In the Pipeline Topic -->'
        '    <div class="guide-token-panel cat-biology panel-pipeline">'
        '      <div class="guide-token-top-row">'
        '        <h3 class="guide-token-title">Vitamin-Microbiome Bidirectional Loop</h3>'
        '        <button class="backlog-votes vote-cta-btn guide-token-btn" style="pointer-events: none;" aria-label="Upvote topic proposal">'
        '          <span class="upvote-icon">▲</span>'
        '          <span class="vote-label">UPVOTE</span>'
        '          <span class="vote-count">(0)</span>'
        '        </button>'
        '      </div>'
        '      <div class="guide-token-tag-row">'
        ...
        '      </div>'
        '      <blockquote class="card-teaser-text card-analogy-block guide-token-analogy">'
        ...
        '        </div>'
        '      </blockquote>'
        '      <div class="guide-token-footer-row">'
        '        <div class="card-tags">'
        '          <span class="tag-pill">#biology</span>'
        '          <span class="tag-pill">#metabolism</span>'
        '        </div>'
        '        <span class="card-meta-dates">Proposed: 2026-06-15</span>'
        '      </div>'
        '      <p class="guide-token-caption">🌿 <strong>In the Pipeline:</strong> Reader-proposed topics undergoing citation auditing. Click <strong>▲ Upvote</strong> to prioritize research!</p>'
        '    </div>'
        '    <!-- Panel 2: Published Summary Decoding -->'
        '    <div class="guide-token-panel cat-biology panel-summaries">'
        '      <div class="guide-token-top-row">'
        '        <h3 class="guide-token-title">DHA Target Engagement &amp; Cognition in Dementia Risk</h3>'
        '        <span class="read-article-btn guide-token-btn" style="pointer-events: none;">'
        ...
        '        </div>'
        '        <span class="card-meta-dates">Created: 2026-06-01</span>'
        '      </div>'
        '      <p class="guide-token-caption">📖 <strong>Summaries:</strong> Completed decodings with 1-min takeaways, cellular dynamics &amp; evidence ratings.</p>'
        '    </div>'
        '  </div>'
        '</div>'
    )
