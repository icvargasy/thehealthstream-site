...
def render_interactive_sample_card() -> str:
    """Renders a visitor guide banner embedding actual card visual UI tokens (badges & CTAs) at the top of index.html."""
    git_branch_svg = (
        '<svg class="pipeline-icon-svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">'
        '  <line x1="6" y1="3" x2="6" y2="15"></line>'
        '  <circle cx="18" cy="6" r="3"></circle>'
    ...
    return (
        ...
        '    <!-- Panel 1: Summaries -->'
        '    <div class="guide-token-panel panel-summaries">'
        '      <div class="guide-token-header">'
        '        <span class="evidence-badge tier-consensus guide-token-badge">✓ CONSENSUS CORE</span>'
        '        <span class="read-article-btn guide-token-btn" style="pointer-events: none;">'
        '          <span>Read Summary</span>'
        '          <span>&rarr;</span>'
        '        </span>'
        '      </div>'
        '      <p class="guide-token-text"><strong>Summaries:</strong> Completed decodings with 1-min takeaways, cellular dynamics &amp; evidence ratings.</p>'
        '    </div>'
        '    <!-- Panel 2: In the Pipeline -->'
        '    <div class="guide-token-panel panel-pipeline">'
        '      <div class="guide-token-header">'
        '        <span class="pipeline-badge guide-token-badge">' + git_branch_svg + 'IN THE PIPELINE</span>'
        ...
        '        </button>'
        '      </div>'
        '      <p class="guide-token-text"><strong>In the Pipeline:</strong> Reader-proposed topics under review. Click <strong>▲ Upvote</strong> to prioritize research!</p>'
        '    </div>'
        '  </div>'
        '</div>'
    )
